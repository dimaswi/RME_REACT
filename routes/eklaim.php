...
Route::middleware('auth')->group(function () {
    ...
    Route::post('eklaim/klaim/edit-data/store/tagihan/obat', [\App\Http\Controllers\Eklaim\EditDataController::class, 'StoreEditTagihanObat'])->name('eklaim.editData.storeTagihanObat');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('eklaim/klaim/uploadDokumen/{pengajuanKlaim}/preview', [UploadDokumenController::class, 'previewFileUpload'])->name('eklaim.klaim.previewFileUpload');
});
