...
export default function Triage({ imageBase64, onChange, nomorKunjungan }: TriageProps) {
        ...
        await axios.get(route('eklaim.getDataTriage', { nomorKunjungan: nomorKunjungan }))
            .then(response => {
                setForm({
                    ...
                    urgent: urgent || false,
                    lessUrgent: lessUrgent || false,
                    nonUrgent: nonUrgent || false,
                    zonaHitam: zonaHitam || false,
                });
    ...
    const [form, setForm] = useState({
        ...
        pengantar: "",
        pasienRujukan: "",
        pasienRujukanSisrute: false,
        dikirimPolisi: "",
        permintaanVisum: false,
        jenisKasus: "",
        lokasiKasus: "",
        lakaLantas: false,
        kecelakaanKerja: false,
        keluhanUtama: "",
        anamnesaTerpimpin: "",
        tekananDarah: "",
        nadi: "",
        ...
        <div className="pt-4">
            {
                nomorKunjungan ? (
                    ...
                    <div className="text-center text-red-500">
                        <p>Nomor Kunjungan tidak tersedia. Silakan pilih nomor kunjungan terlebih dahulu.</p>
                    </div>
                )
            }
        </div>
