...
export default function ModalBuatPengajuanBaru({ open, onOpenChange }: Props) {
        ...
        <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/40 pt-10 text-sm" onMouseDown={handleBackdropClick}>
            ...
            >
                    ...
                    {paginatedSEP.length > 0 && !selectedSEP && (
                        <div className="mt-4">
                            <Table>
                                ...
                                <TableBody>
                                    {paginatedSEP.map((sep: any) => (
                                        <TableRow key={sep.noSEP}>
                                            <TableCell>
                                                <button className="text-blue-600 hover:underline" onClick={() => setSelectedSEP(sep)} type="button">
                                                    {sep.noSEP}
                                                </button>
                                            </TableCell>
                ...
                <div className="mt-6 flex justify-end gap-2">
                    ...
                    <button className="rounded-lg bg-blue-600 px-5 py-2 text-white transition hover:bg-blue-700" onClick={() => onOpenChange(false)}>
                        Simpan
                    </button>
                </div>
            </div>
